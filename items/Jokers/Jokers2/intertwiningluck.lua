SMODS.Joker{
    ...
    calculate = function(self, card, context)
        if context.setting_blind and G.GAME.dollars + G.GAME.dollar_buffer > to_big(6) and card.ability.extra.wishcost and #G.jokers.cards + G.GAME.joker_buffer < G.jokers.config.card_limit then
