return{
    dictionary={
        cami_charge="CHARGE!",
        cami_retreat="RETREAT!",
        usagi_laugh="Uwa-ha!",
        usagi_laugh2="Iya-ha!",
        usagi_laugh3="Waa-ha!",
        comedy_succ="Friggin Sweet!",
        comedy_blow="Crack.",
        comedy_stoned="Stoned!",
        comedy_loser="Capiche!",
        psycro_planet="It's Singing.",
        psycro_seal="It's Crying.",
        psycro_die="Im Sorry.",
        psycro_idle="...",
        blank_rolled="!",
        blank_failed="?",
        ...
        Joker = {
            ...
            j_tje_Schneider = {
                ...
                text = {
                    ...
                    '{C:attention}After Scoring{} {C:chips}First Hand{}, {C:mult}Schneider{} takes a rest',
                    '{C:mult}Schneider{} {c:attention}gains{} {X:mult,C:white}X0.1{} per scored {C:hearts}Hearts{}',
                    ...
                    '{s:0.7,C:inactive}Aditionally, after defeating{} {s:0.7,C:attention}Boss Blind{}{s:0.7,C:inactive},{} {s:0.7,C:attention,s:0.7}Fill{} {C:inactive,s:0.7}your{} {s:0.7,C:attention}Consumable Slots{} {C:inactive,s:0.7}with{}',
                    '{C:inactive,s:0.7}A{} {s:0.7,C:mult}Slice{} {C:inactive,s:0.7}of{} {s:0.7,C:attention}Life{}',
                    '{C:inactive}"Who cares whether the shelter is the eave...{}',
                    '{C:inactive}Or the rubble?"{}'
                }
            },
            j_tje_Crystal = {
                name = 'CRYSTA//',
                text = {
                    ...
                    "{C:inactive,s:0.75}Where N is your played hands current level, and N2 is your current Charge.{}",
            ...
            j_tje_tsunova = {
                ...
                text = {
                    "{C:green}#1#{} in {C:green}#2#{} chance to",
                    "{C:attention}Create{} a {C:green}random{}",
                    "{C:planet}Planet{} when using a",
                    "non {C:planet}Planet{} {C:attention}Consumable{}",
                    "{C:green}#1#{} in {C:green}#3#{} chance to also",
                    "{C:red}level down{} most played hand when",
                    "using a {C:planet}Planet{} {C:attention}Consumable{}",
                    "{C:inactive,s:0.75}[Needs Space]{}",
                    "{C:inactive}----------------------------{}",
            ...
            j_tje_intertwiningluck = {
                ...
                text = {
                    ...
                    "{C:inactive,s:0.75}[Needs Space]{}",
                    "{C:inactive,s:0.75}[{}{C:rare,s:0.75}Rare{} {C:inactive,s:0.75}Pity: #6#]{}{C:inactive,s:0.75} [{}{C:legendary,s:0.75}Legendary{} {C:inactive,s:0.75}Pity: #7#]{}",
                    "{C:inactive}-------------------------{}",
